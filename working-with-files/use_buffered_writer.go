...
func main() {
	...
	log.Printf("Bytes written (byte): %d\r\n", bytesWritten)
	...
	// See how much buffer is available
	bytesAvailableAfterFlush := bufferedWriter.Available()
	log.Printf("Bytes available after flush: %d\r\n", bytesAvailableAfterFlush)
	...
	bytesAvailableAfterResize := bufferedWriter.Available()
	log.Printf("Bytes available after resizing: %d", bytesAvailableAfterResize)
